...
Dentist_Programme: Dentist_Programme.cpp Print_Functions.h Person.o Dentist.o Patient.o Appointment.o Room.o Data.o CSV_Reader.o Interface.o Calendar.o Input_Validation.o
	$(CXX) $(CXXFLAGS) -o $@ $^
